...
/*
            if(movingPiece.getIcon() == bking.getIcon() && xInt == 5 && yInt == 7) {
                int dialogResult = JOptionPane.showConfirmDialog (frame, "Would you like to perform a castling?","Castling", JOptionPane.YES_NO_OPTION);
            }//black castling
//            if(movingPiece.getIcon() == wking.getIcon() &&  && xInt == x && yInt == y) {}//white castling
*/
